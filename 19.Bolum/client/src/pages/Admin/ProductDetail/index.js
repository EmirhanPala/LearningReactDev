...
import { Box, FormControl, Text, FormLabel, Input, Textarea, Button } from '@chakra-ui/react';
...
function ProductDetail() {
    ...
    /*
    values: o anda inputa girilmiş olan ifadeler nelerse onlar.
    bag: o form ile alakalı yapılabilecek bir takım fonksiyonlar oluyor.
    Formu resetlemek gibi validasyonları tekrar çalıştırmak gibi tanımlar var kullanılabilir.
    */
                                                    ...
                                                    <div>
                                                        {
                                                            values.photos && values.photos.map((photo, index) => (
                                                                <div key={index}>
                                                                    ...
                                                                    <Button ml="4" type="button" colorScheme="red" disabled={isSubmitting} onClick={() => arrayHelpers.remove(index)}>
                                                                        Remove
                                                                    </Button>
                                                                </div>
                                                            ))
